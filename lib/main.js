...
function runAutomationWorker() {
    //automation.automate(worker, site, params, callback, failure_callback, true);
    var fb = AUTOMATION_CONFIG['www.facebook.com'];
    automation.automate(fb.content_script, fb.url, ['changePassword'], {'old_password': 'old', 'new_password': 'new'}, {});
}
